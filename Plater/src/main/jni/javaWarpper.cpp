...
Java_com_cocoa_plater_PlateRecognition_InitPlateRecognizer(
...
Java_com_cocoa_plater_PlateRecognition_SimpleRecognization(
        JNIEnv *env, jobject obj,
...
Java_com_cocoa_plater_PlateRecognition_ReleasePlateRecognizer(JNIEnv *env, jobject obj,
                                                                  jlong object_re) {
